		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach items="${pageBean.list }" var="product">
				<div class="col-md-2" style="text-align:center">
					<a href="${pageContext.request.contextPath }/product?method=getProductById&productId=${product.pid}">
						<img src="${pageContext.request.contextPath}/${product.pimage}" width="170" height="170" style="display: inline-block;">
					</a>
					<p><a href="${pageContext.request.contextPath }/product?method=getProductById&productId=${product.pid}" style='color:green' title="${product.pname}">${fn:substring(product.pname,0,10) }...</a></p>
